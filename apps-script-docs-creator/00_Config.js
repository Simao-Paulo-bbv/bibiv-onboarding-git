const CONFIG = {
  ...
  DOC_GENERATOR: {
    ...
    ACTIVE_JOB_KEY: "DOCGEN_ACTIVE_JOB",
    ACTIVE_JOB_TTL_SECONDS: 1800,
    FILE_TASK_QUEUE_KEY: "DOCGEN_FILE_TASK_QUEUE",
    FILE_IN_FLIGHT_KEY: "DOCGEN_FILE_IN_FLIGHT",
    FINALIZER_QUEUE_KEY: "DOCGEN_FINALIZER_QUEUE",
    QUEUE_TRIGGER_MINUTES: 1,
    FILE_WORKER_PARALLELISM: 3,
    FILE_WORKER_BATCH_MAX_ITEMS: 1,
    FILE_WORKER_MAX_RUNTIME_MS: 240000,
    FILE_WORKER_LEASE_TTL_SECONDS: 900,
